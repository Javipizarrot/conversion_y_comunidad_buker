...
En nuestro **Tech Blog** puedes encontrar temas como:
- Migración de low-code a Rails.
- Resiliencia y optimización con instancias AWS Spot.
...
* Mantenimiento de gemas propias (`active_record_query_count`, `buk-atlas`).
* Contribuciones a librerías globales (`amazing_print`, `irb_fzf_history`).
...
<img src="b1b77ab3-779e-4709-9e78-89a0e0def88b.png" alt="Proceso Tech" width="500">
